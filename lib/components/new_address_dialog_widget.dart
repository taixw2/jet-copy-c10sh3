...
import 'new_address_dialog_model.dart';
export 'new_address_dialog_model.dart';

class NewAddressDialogWidget extends StatefulWidget {
  const NewAddressDialogWidget({super.key});
...
class _NewAddressDialogWidgetState extends State<NewAddressDialogWidget> {
  late NewAddressDialogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewAddressDialogModel());
